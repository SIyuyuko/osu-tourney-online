...
-->
<template>
	<a-tabs ref="paneRef" class="album-panel" v-model:activeKey="activeKey" hide-add type="editable-card" @edit="onEdit"
...
let listData = ref([
	{
		...
		cover: "https://i.ppy.sh/f5982d2fe7d489faac36230fc235617f3bd1f6b9/68747470733a2f2f6f73752e7070792e73682f77696b692f696d616765732f7368617265642f6e6577732f62616e6e6572732f70726f6a6563742d6c6f7665642d322e6a7067",
		key: "#a1",
		creator: 9794030,
		description: "Loved beatmaps may not meet the ranking criteria, but are loved by the community and thus are regularly added based on community votes in Project Loved. They have leaderboards, but no performance points will be awarded and all scores will be deleted if it moves out of Loved (this usually only happens on the creator's request). Loved beatmaps use the heart icon (❤️) in the song selection screen."
	},
	// {
	// 	title: 'Album 2',
